...
export default function EmailPreviewPage() {
  const [activeTemplate, setActiveTemplate] = useState<"notification" | "thankyou">("notification");
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div>
              ...
              <p className="text-gray-600">Preview your beautiful email templates</p>
            </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-lg font-semibold text-gray-900">
                  {activeTemplate === "notification" ? "Contact Notification Email" : "Thank You Email"}
                </h3>
              ...
              <div className="text-sm text-gray-500">
                <div><strong>To:</strong> {activeTemplate === "notification" ? "you@example.com" : sampleData.email}</div>
                <div><strong>From:</strong> {activeTemplate === "notification" ? sampleData.email : "you@example.com"}</div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
          ...
          <div className="text-blue-800 space-y-2">
            <p>1. These templates are automatically used in your contact form API</p>
            <p>2. Customize the social links and portfolio URL in the templates</p>
